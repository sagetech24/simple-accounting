...
* @route '/suppliers'
*/
const Controller073ded02199f68a48f337dc13452fc18 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller073ded02199f68a48f337dc13452fc18.url(options),
    method: 'get',
})

Controller073ded02199f68a48f337dc13452fc18.definition = {
    methods: ["get","head"],
    url: '/suppliers',
...
* @route '/suppliers'
*/
Controller073ded02199f68a48f337dc13452fc18.url = (options?: RouteQueryOptions) => {
    return Controller073ded02199f68a48f337dc13452fc18.definition.url + queryParams(options)
}
...
* @route '/suppliers'
*/
Controller073ded02199f68a48f337dc13452fc18.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller073ded02199f68a48f337dc13452fc18.url(options),
    method: 'get',
})
...
* @route '/suppliers'
*/
Controller073ded02199f68a48f337dc13452fc18.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller073ded02199f68a48f337dc13452fc18.url(options),
    method: 'head',
})
...
*/
const Controller = {
    '/suppliers': Controller073ded02199f68a48f337dc13452fc18,
