...
* @see app/Http/Controllers/SalesOrderController.php:154
...
* @see app/Http/Controllers/SalesOrderController.php:25
* @route '/sales-orders'
*/
...
* @see app/Http/Controllers/SalesOrderController.php:93
* @route '/sales-orders'
*/
...
* @see app/Http/Controllers/SalesOrderController.php:133
...
const SalesOrderController = { restore, index, store, destroy }
