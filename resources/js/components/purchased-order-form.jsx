...
export default function PurchasedOrderForm({
    suppliers,
    products,
    order = null,
    onCancel,
    ...
    function submit(event) {
        ...
        if (isEditing) {
            form.put(update.url(order.id), options);
            return;
        }
        ...
        <form onSubmit={submit} className="space-y-6">
            {isEditing && (
                <p className="rounded-md border border-line bg-mist/40 px-3 py-2 text-sm text-ink-soft">
                    Editing {order.status_label.toLowerCase()} purchase order.
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                <div>
                    ...
                    <p className="mt-1.5 text-xs text-muted">
                        Auto-generated UUID for this purchase order.
                    </p>
