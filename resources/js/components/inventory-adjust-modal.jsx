    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto px-4 py-10 sm:px-6">
            ...
            <div
                ...
                className="relative z-10 w-full max-w-md origin-top rounded-lg border border-line bg-white p-6 shadow-xl opacity-0 motion-safe:animate-[product-modal-slide-down_0.35s_ease-out_forwards] motion-reduce:opacity-100"
            >
